package com.joaogdantas.SimpleBusinessCardApp.infra.config;
...
public class OpenAPIConfig {
    ...
    @Value("${joaogdantas.openapi.dev-url}")
    ...
    public OpenAPI myOpenAPI() {
        ...
        Info info = new Info()
                ...
                .version("0.0.1")
                .contact(contact)
                .description("Uma API para um app de criação de cartões de visita.").termsOfService("https://github.com/joaogdantas/BusinessCardAPI")
                .license(License);
